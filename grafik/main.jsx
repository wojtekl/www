            ...
            <div class="row">
              ...
              return <>
                ...
                { currentDay.length < 1 ? <div class="col-sm-11">  - - -  </div> : currentDay.map(g => 
                  <div class={`bg-warning-subtle border border-secondary col-sm-${g.period/3}`}>{`${g.time}`} - <DateFormatter timestamp={new Date(new Date(g.starting).getTime() + g.period * 60 * 60 * 1000)} locale={locale} format="time" /></div>
                ) }
                <div class="w-100"></div>
              </>
              }
